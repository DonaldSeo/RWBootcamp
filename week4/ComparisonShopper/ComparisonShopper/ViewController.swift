...
class ViewController: UIViewController {
    ...
    func revertEmptyUI() {
        titleLabelRight.alpha = titleLabelLeft.alpha
        imageViewRight.alpha = imageViewLeft.alpha
        priceLabelRight.alpha = priceLabelLeft.alpha
        roomLabelRight.alpha = roomLabelLeft.alpha
    }
